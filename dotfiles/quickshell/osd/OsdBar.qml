    ...
    Item{
      ...
      Rectangle{
        ...
        Rectangle{
          ...
          width:isVertical?parent.width:(parent.width*(Math.min(root.percentage,100)/100))
          height:isVertical?(parent.height*(Math.min(root.percentage,100)/100)):parent.height
